...
/* themes/custom/march/templates/navigation/menu--primary-menu.html.twig */
class __TwigTemplate_05ecbd6eebd11c7aec8f686abb5ac40d extends Template
{
    private $source;
    private $macros = [];
...
($context["is_top_level_menu"] ?? null) && twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return "themes/custom/march/templates/navigation/menu--primary-menu.html.twig";
    }
...
{% macro menu_links(items, attributes, menu_level, aria_id) %}
  ...
  {% endif %}
{% endmacro %}
", "themes/custom/march/templates/navigation/menu--primary-menu.html.twig", "C:\\xampp\\htdocs\\ashes\\web\\themes\\custom\\march\\templates\\navigation\\menu--primary-menu.html.twig");
    }
